...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/all_test

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/all_test: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/all_test ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/ABC.o: ABC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ABC.o ABC.cpp

${OBJECTDIR}/epoll_et_test.o: epoll_et_test.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/epoll_et_test.o epoll_et_test.cpp

${OBJECTDIR}/first_epoll.o: first_epoll.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/first_epoll.o first_epoll.cpp

${OBJECTDIR}/for_fork_puzzle.o: for_fork_puzzle.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_fork_puzzle.o for_fork_puzzle.cpp
...
${OBJECTDIR}/recvmsg.o: recvmsg.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/recvmsg.o recvmsg.cpp

${OBJECTDIR}/sendmsg.o: sendmsg.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sendmsg.o sendmsg.cpp

${OBJECTDIR}/sizeof_test.o: sizeof_test.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sizeof_test.o sizeof_test.cpp
...
${OBJECTDIR}/socketpair_test.o: socketpair_test.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socketpair_test.o socketpair_test.cpp
